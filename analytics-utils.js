(function (root) {
	...
	const EVENTS_REPORT_PATH = "/reports/explorer?params=_u..nav%3Dmaui&r=top-events";
	const TRAFFIC_ACQUISITION_PATH = "/reports/explorer?params=_u..nav%3Dmaui&r=lifecycle-traffic-acquisition-v2";
